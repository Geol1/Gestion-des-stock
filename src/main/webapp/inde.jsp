...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.html"><span>M</span>yStock</a></h1>
      </div>
        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Se connecter</span> <i class="bi bi-chevron-down"></i></a>
            <ul style="padding:15px;">
                 <li>
<button type="button" class="btn bg-light mx-auto" style="margin:0px 5px 10px;" data-toggle="modal" data-target="#exampleModalCenter">Magasinier</button>
                 </li>
                 <li><input type="button" class="btn bg-light" data-toggle="modal" data-target="#loginMag" value="Administrateur" onclick="console.log('test')"/></li>
            </ul>
          </li>
        </ul>
  ...
  <a href="#" class="back-to-top d-flex align-items-center justify-content-center"><i class="bi bi-arrow-up-short"></i></a>
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content bg-secondary">
				<div class="modal-header">
					<button type="button"
						class="close d-flex align-items-center justify-content-center bg-danger"
				...
				<div class="modal-body p-4 p-md-5">
					<div class="icon d-flex align-items-center justify-content-center">
						<span class="ion-ios-person"
							style="font-size: 100px; color: blue;"></span>
					</div>
						...
						<div class="form-group d-md-flex">
							<div class="form-check w-50">
								<label class="custom-control fill-checkbox"> <input
									...
									class="fill-control-description">Remember Me</span>
								</label>
							</div>
						</div>
					</form>
	...
	<div class="modal fade" id="loginMag" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content bg-secondary">
				...
				<div class="modal-body p-4 p-md-5">
					<div class="icon d-flex align-items-center justify-content-center">
						<span class="ion-ios-person" style="font-size: 100px; color: blue;"></span>
					</div>
